...
for i in range(len(Runs)):
    ...
    print W_l.shape
    # ADD in netcdf write #########
    f = netCDF4.Dataset(str(fname)+'/layer_int/Remapped.nc','w')
    ...
    f = netCDF4.Dataset(str(fname)+'/layer_int/Eddy_L.nc','w')
    f.createDimension('T',g.ng)
    f.createDimension('Y',c.Ny)
    f.createDimension('X',c.Nx)
    ...
    f = netCDF4.Dataset(str(fname)+'/layer_int/Remapped_bar.nc','w')
    f.createDimension('T',g.ng)
    f.createDimension('Y',c.Ny)
    f.createDimension('X',c.Nx)
